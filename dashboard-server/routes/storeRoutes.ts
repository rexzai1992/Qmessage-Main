...
function renderStorePage(args: { company: any; products: any[]; companyId: string }) {
    ...
    const storeSubtitle = readTrimmed(company?.webstore_subtitle) || 'Browse products and pricing. Built for webstore and WhatsApp workflows.'
...
<body>
  <main class="wrap">
    <section class="hero">
      ...
      <h1>Build. Sell. Engage.</h1>
      <p>Customixie helps you publish webstore products, keep pricing organized, and engage customers through WhatsApp messaging.</p>
      <div class="cta">
      ...
      <div class="cards">
        ...
        <article class="card">
          ...
          <p>Keep product details and pricing consistent across your storefront and internal workflows.</p>
        </article>
        <article class="card">
          <h3>WABA Compatible</h3>
          <p>Use approved templates to deliver timely, structured updates to your customers.</p>
        </article>
      </div>
    </section>
  </main>
